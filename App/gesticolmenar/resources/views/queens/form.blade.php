                        ...
                        <form action="{{ route($path, $queen) }}" method="POST">
                            ...
                            <div class="form-outline mb-1">
                              ...
                              <select class="form-select form-select-lg" name="race" id="race" name="race">
                                @foreach($races as $race)
                                  <option value="{{ $race }}" {{ old('race', $queen->race) == $race ? 'selected' : '' }}>{{ $race }}</option>
                                @endforeach
                              </select>
                          </div>
                            ...
                            <div class="form-outline mb-1">
                                ...
                                <input type="text" id="start_date" name="start_date"
                                    class="form-control form-control-lg shadow-none input-disabled" value="{{ old('start_date', $queen->start_date) }}" readonly/>
                            ...
                            <div class="form-outline mb-1">
                                ...
                                <input type="text" id="end_date" name="end_date"
                                    class="form-control form-control-lg shadow-none input-disabled" value="{{ old('end_date', $queen->end_date) }}" readonly />
